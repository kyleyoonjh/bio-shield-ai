...
// ─── Assay Design (Phase 3) ───────────────────────────────────────────────────

export type AssayJobStatus = "RUNNING" | "COMPLETED" | "FAILED";
...
export interface AssayDesignResult {
  job_id: string;
  status: AssayJobStatus;
  message: string;
}
